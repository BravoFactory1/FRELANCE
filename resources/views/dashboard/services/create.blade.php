                                                ...
                                                <div class="row">
                                                    <div class="col-12 ">
                                                        <div class="form-group">
                                                            <label for="categories_id">اختيار التصنيف:</label>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea id="shortdes{{ $key }}" name="shortdescription[{{ $key }}]" class="form-control"
                                                                placeholder="Crop mini shortdescription">{{ old('shortdescription') }}</textarea>
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea id="Pagedesc{{ $key }}" name="description[{{ $key }}]" class="form-control"
                                                                placeholder="Crop mini description">{{ old('description') }}</textarea>
                                                            @error('description')
                                                                <div class="invalid-feedback">
                                                                    <strong>{{ $message }}</strong>
                                                                </div>

                ...
                <div class="widget-header">
                    <div class="row">
                        <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                            <h4>Update categories ({{ $categories->name }})</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="widget-content widget-content-area">
                    <div class="row">
                        <div class="col-lg-12 col-12 ">
                            <form action="{{ route('categoriess.update', ['categories' => $categories->id]) }}"
                                                    ...
                                                    <div class="col-12 ">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" name="name[{{ $key }}]"
                                                                ...
                                                                value="{{ old('name', $categories->getTranslations()['name'][$key]) }}"
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <textarea id="Pagedesc{{ $key }}" name="description[{{ $key }}]" class="form-control"
                                                                ...
                                                                {{ old('description', @$categories->getTranslations()['description'][$key]) }}
